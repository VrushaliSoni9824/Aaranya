...
import {Splash, Login, Signup,SignupOTPVerify, ProfileFirst, Product, Home} from '../screens';
...
import { LOGOUTSCREEN, SHIPPINGPOLICY, TERMCNDITION, MYSUBSCRIPTIONSCREEN, PROFILESCREEN, HOMETABSTACK, HOMESCREEN } from "../constants/Screens";
...
<View style={{ paddingHorizontal: 20, paddingTop: 30 }}>
             <View style={styles.row}>
               ...
               <View styles={{ width: '70%', marginLeft: 20,  }}>
                   <Text style={{ fontWeight: 'normal', color: '#087E8B', fontSize: 15 ,marginTop: 20}}>Hi {props.reduxUser.customer.name}</Text>
                 </View>
             </View>
     ...
     icon = {({color, size}) => (
       <Icon name="shield-account" color={colsor} size={size} />
     )} />
