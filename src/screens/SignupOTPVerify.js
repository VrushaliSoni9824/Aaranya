...
import { Dimensions, StatusBar, StyleSheet, Text, View, TextInput,ScrollView, KeyboardAvoidingView, ActivityIndicator, Keyboard, Platform } from 'react-native'
import { TouchableOpacity } from 'react-native-gesture-handler';
import * as Animatable  from 'react-native-animatable';
import { connect } from 'react-redux';
import { COLORS } from '../constants/Colors';
import { FORGOTPASSWORDSCREEN, LOGINSCREEN, PROFILESCREEN, PROFILEFIRSTSCREEN } from '../constants/Screens';
        ...
        <View style={[styles.container, styles.headerSpace]}>
            ...
            <Animatable.View style={styles.footer} animation="fadeInUpBig" > 
                ...
                {/* <OTPInputView
                    ...
                    codeInputFieldStyle={{backgroundColor: 'white'}}
                ...
                {/* {Platform.OS == 'ios' && 
                    <View style={{justifyContent: 'center', flex: 1, alignItems: 'center', marginVertical: 100}}>
                        <OTPInput
                            value={otp}
                            onChange={(text) => {
                                    setotp(text);
