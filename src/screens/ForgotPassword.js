    ...
    return (
        ...
        <View style={[styles.container, styles.headerSpace]}>
            ...
            <Animatable.View style={styles.footer} animation="fadeInUpBig" > 
                <Text style={[styles.title,{color:'#ebebd3'}]}>Forgot Password?</Text>
        ...
        <Text style={{textAlign:'center'}}>Problem in reset password?</Text>
        <Text style={{textAlign:'center',marginTop:5, fontSize:16, fontWeight:'700',color:'#ebebd3'}}>Contact Support</Text>
